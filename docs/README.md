# Building the [API Documentation Site](https://glitchedpolygons.github.io/RepositoryPattern/api/index.html)
---
...
* * https://glitchedpolygons.github.io/RepositoryPattern/api/index.html
